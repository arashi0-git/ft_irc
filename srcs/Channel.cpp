...
Channel::Channel()
    : _name(""), _topic(""), _members(), _operators(), _invited(), _inviteOnly(false),
      _topicSet(false), _hasKey(false), _key(""), _hasLimit(false), _userLimit(0) {}

Channel::Channel(const std::string &name)
    : _name(name), _topic(""), _members(), _operators(), _invited(), _inviteOnly(false),
      _topicSet(false), _hasKey(false), _key(""), _hasLimit(false), _userLimit(0) {}
...
void Channel::setTopicFlag(bool flag) { _topicSet = flag; }

bool Channel::isTopic() const { return _topicSet; }
